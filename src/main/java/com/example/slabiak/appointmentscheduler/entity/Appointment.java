...
public class Appointment extends BaseEntity implements Comparable<Appointment> {
    ...
    public Appointment(LocalDateTime start, LocalDateTime end, Customer customer, Teacher teacher, Work work) {
        this.start = start;
        this.end = end;
    ...
    public void setTeacher(Teacher provider) {
        this.teacher = provider;
    }
