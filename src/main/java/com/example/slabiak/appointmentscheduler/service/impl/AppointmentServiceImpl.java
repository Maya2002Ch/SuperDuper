...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    @Override
    @PostAuthorize("returnObject.teacher.id == principal.id or returnObject.customer.id == principal.id or hasRole('ADMIN') ")
    ...
    public List<TimePeroid> getAvailableHours(int providerId, int customerId, int workId, LocalDate date) {
        Teacher p = userService.getProviderById(providerId);
    ...
    public void createNewAppointment(int workId, int providerId, int customerId, LocalDateTime start) {
        if (isAvailable(workId, providerId, customerId, start)) {
            ...
            appointment.setTeacher(userService.getProviderById(providerId));
    ...
    public void addMessageToAppointmentChat(int appointmentId, int authorId, ChatMessage chatMessage) {
        ...
        if (appointment.getTeacher().getId() == authorId || appointment.getCustomer().getId() == authorId) {
    ...
    public void cancelUserAppointmentById(int appointmentId, int userId) {
        ...
        if (appointment.getCustomer().getId() == userId || appointment.getTeacher().getId() == userId) {
            ...
            } else if (canceler.equals(appointment.getTeacher())) {
    ...
    public boolean isProviderAllowedToAcceptRejection(int providerId, int appointmentId) {
        ...
        return appointment.getTeacher().equals(user) && appointment.getStatus().equals(AppointmentStatus.REJECTION_REQUESTED);
    }
    ...
    public String getCancelNotAllowedReason(int userId, int appointmentId) {
        ...
        if (appointment.getTeacher().equals(user)) {
