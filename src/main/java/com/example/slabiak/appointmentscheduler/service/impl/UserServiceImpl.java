...
import com.example.slabiak.appointmentscheduler.entity.user.customer.Student;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public Teacher getProviderById(int providerId) {
    ...
    public Student getRetailCustomerById(int retailCustomerId) {
    ...
    public List<Teacher> getAllProviders() {
    ...
    @Override
    public List<Student> getAllRetailCustomers() {
    ...
    @Override
    public List<Teacher> getProvidersWithRetailWorks() {
        return providerRepository.findAllWithRetailWorks();
    }

    @Override
    public List<Teacher> getProvidersWithCorporateWorks() {
        return providerRepository.findAllWithCorporateWorks();
    }

    @Override
    public List<Teacher> getProvidersByWork(Work work) {
    ...
    public void updateProviderProfile(UserForm updateData) {
        Teacher teacher = providerRepository.getOne(updateData.getId());
        teacher.update(updateData);
        providerRepository.save(teacher);
    }

    @Override
    @PreAuthorize("#updateData.id == principal.id or hasRole('ADMIN')")
    public void updateRetailCustomerProfile(UserForm updateData) {
        Student retailCustomer = retailCustomerRepository.getOne(updateData.getId());
    ...
    public void saveNewRetailCustomer(UserForm userForm) {
        Student retailCustomer = new Student(userForm, passwordEncoder.encode(userForm.getPassword()), getRolesForRetailCustomer());
        retailCustomerRepository.save(retailCustomer);
    }
    ...
    public void saveNewProvider(UserForm userForm) {
        ...
        Teacher teacher = new Teacher(userForm, passwordEncoder.encode(userForm.getPassword()), getRolesForProvider(), workingPlan);
        providerRepository.save(teacher);
    }
