...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendAppointmentRejectionRequestedNotification(Appointment appointment) {
        ...
        sendEmail(appointment.getTeacher().getEmail(), "Rejection requested", "appointmentRejectionRequested", context, null);
    }
    ...
    public void sendNewAppointmentScheduledNotification(Appointment appointment) {
        Context context = new Context();
        context.setVariable("appointment", appointment);
        sendEmail(appointment.getTeacher().getEmail(), "New appointment booked", "newAppointmentScheduled", context, null);
    }
    ...
    public void sendAppointmentCanceledByCustomerNotification(Appointment appointment) {
        ...
        sendEmail(appointment.getTeacher().getEmail(), "Appointment canceled by Customer", "appointmentCanceled", context, null);
    }
    ...
    public void sendNewChatMessageNotification(ChatMessage chatMessage) {
        Context context = new Context();
        User recipent = chatMessage.getAuthor() == chatMessage.getAppointment().getTeacher() ? chatMessage.getAppointment().getCustomer() : chatMessage.getAppointment().getTeacher();
